...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE responsabile SET contatto = '$telefono' where cf = '$cf'";
    ...
    if ($tel != 'not valid') {
        ...
        if (!$result) {
            ...
            echo "Aggiornamento avvenuto con successo<br><a href='responsabile_update.php'>ritorna</a>";
        };
    }else {
...
{
    echo '<form method="POST" action="responsabile_update.php">';
